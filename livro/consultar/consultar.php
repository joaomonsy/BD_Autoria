...
<form name="cliente" method = "POST" action = "">
    <div class="main-prod">
            ...
            <?php
                    ...
                    $pro_bd=$p->consultar();
                        ...
                        foreach ($pro_bd as $pro_mostrar) 
                        {
                            ...
                            <b> <?php echo "Quantidade de Páginas: &emsp;" . $pro_mostrar[5] ."<br> "?></b><br>
                            <?php echo '</div>' ?>
                            <?php
                        }
                    }
        ...
        <div class="right-prod">
            <div class="card-prod">
                <div class="textfield">
                    <label for="produto">Nome do Título:</label>
                    <input type="text" name="txtNome" placeholder="Digite o Nome do Título do livro que será consultado">
                </div>
