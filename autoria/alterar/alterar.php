...
<body>
    <div class="main-prod">
        <div class="left-prod">
            <h1>Alterar Autoria</h1>
            <form name="cliente" method="POST" action="alterar2.php">

                <fieldset>
                    <legend><b>Informe o Código da autoria desejado: </b></legend>
                    Cód. Autoria: <input class="id" type="text" name="txtid" size="20" maxlength="5" placeholder="Código da autoria">
                    <br><br>
